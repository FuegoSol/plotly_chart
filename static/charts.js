...
// Create the buildCharts function.
    ...
    var targetSample2 = samplesArray.filter(sampleObj => sampleObj.id == sample);  
  
    

    // 2. Create a variable that holds the first sample in the metadata array.
    // Create a variable that holds the first sample in the array.
    var firstSample2 = targetSample2[0];

    // 3. Create a variable that holds the washing frequency.
    washing_freq = firstSample2.washing_freq;
    ...
    var gaugeData = [{
      ...
      mode: "gauge+number",
      value: washing_freq,
      title: { text: "Belly Button Washing Freq", font: { size: 24 } },
